...
set(GTK+_LIBRARIES    ${GTK+_LIBRARY};${PANGO_LIBRARIES};${GDKPIXBUF_LIBRARIES};${ATK_LIBRARIES})
set(GTK+_INCLUDE_DIRS ${GTK+_INCLUDE_DIR};${GDK_CONFIG_INCLUDE_DIR};${PANGO_INCLUDE_DIRS};${GDKPIXBUF_INCLUDE_DIRS};${ATK_INCLUDE_DIRS})
